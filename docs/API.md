...
```go
import "github.com/chuxorg/yanzi/internal/auth"
```
...
- [Constants](<#constants>)
- [Variables](<#variables>)
- [func GenerateKey\(dev bool\) \(fullKey, prefix, hash string, err error\)](<#GenerateKey>)
- [func HashKey\(key string\) string](<#HashKey>)
- [func WithOIDCClaims\(ctx context.Context, claims OIDCClaims\) context.Context](<#WithOIDCClaims>)
- [type APIKey](<#APIKey>)
- [type APIKeyStore](<#APIKeyStore>)
- [type OIDCClaims](<#OIDCClaims>)
  - [func OIDCClaimsFromContext\(ctx context.Context\) \(OIDCClaims, bool\)](<#OIDCClaimsFromContext>)
- [type OIDCValidator](<#OIDCValidator>)
  - [func NewOIDCValidator\(ctx context.Context, cfg config.OIDCConfig\) \(\*OIDCValidator, error\)](<#NewOIDCValidator>)
  - [func \(v \*OIDCValidator\) RefreshKeys\(ctx context.Context\) error](<#OIDCValidator.RefreshKeys>)
  - [func \(v \*OIDCValidator\) Validate\(ctx context.Context, rawToken string\) \(OIDCClaims, Scope, error\)](<#OIDCValidator.Validate>)
- [type Scope](<#Scope>)
  - [func \(s Scope\) Allows\(required Scope\) bool](<#Scope.Allows>)
...
## func [GenerateKey](<https://github.com/chuxorg/yanzi/blob/master/internal/auth/keygen.go#L13>)

```go
func GenerateKey(dev bool) (fullKey, prefix, hash string, err error)
```

GenerateKey creates a new API key, returning the full plaintext key, a display prefix, and its SHA\-256 hex hash. The plaintext key is never stored by callers.

<a name="HashKey"></a>
## func [HashKey](<https://github.com/chuxorg/yanzi/blob/master/internal/auth/keygen.go#L33>)

```go
func HashKey(key string) string
```

HashKey returns the hex\-encoded SHA\-256 hash of key. Used during request validation to look up stored keys.

<a name="WithOIDCClaims"></a>
## func [WithOIDCClaims](<https://github.com/chuxorg/yanzi/blob/master/internal/auth/oidc_context.go#L10>)
...
<a name="APIKey"></a>
## type [APIKey](<https://github.com/chuxorg/yanzi/blob/master/internal/auth/types.go#L33-L42>)
...
## type [APIKeyStore](<https://github.com/chuxorg/yanzi/blob/master/internal/auth/store.go#L9-L15>)
...
<a name="OIDCClaims"></a>
## type [OIDCClaims](<https://github.com/chuxorg/yanzi/blob/master/internal/auth/oidc.go#L14-L20>)
...
<a name="OIDCClaimsFromContext"></a>
### func [OIDCClaimsFromContext](<https://github.com/chuxorg/yanzi/blob/master/internal/auth/oidc_context.go#L16>)

```go
func OIDCClaimsFromContext(ctx context.Context) (OIDCClaims, bool)
```

OIDCClaimsFromContext retrieves OIDC claims stored in ctx, returning false if the request was not authenticated via OIDC.

<a name="OIDCValidator"></a>
## type [OIDCValidator](<https://github.com/chuxorg/yanzi/blob/master/internal/auth/oidc.go#L23-L27>)
...
<a name="NewOIDCValidator"></a>
### func [NewOIDCValidator](<https://github.com/chuxorg/yanzi/blob/master/internal/auth/oidc.go#L31>)

```go
func NewOIDCValidator(ctx context.Context, cfg config.OIDCConfig) (*OIDCValidator, error)
```

NewOIDCValidator fetches the OIDC discovery document from cfg.IssuerURL and constructs a verifier. Returns an error if the provider is unreachable.

<a name="OIDCValidator.RefreshKeys"></a>
### func \(\*OIDCValidator\) [RefreshKeys](<https://github.com/chuxorg/yanzi/blob/master/internal/auth/oidc.go#L89>)

```go
func (v *OIDCValidator) RefreshKeys(ctx context.Context) error
```

RefreshKeys forces a refresh of the OIDC provider's JWKS cache. go\-oidc handles key rotation automatically; this is for manual operational use.

<a name="OIDCValidator.Validate"></a>
### func \(\*OIDCValidator\) [Validate](<https://github.com/chuxorg/yanzi/blob/master/internal/auth/oidc.go#L51>)
...
<a name="Scope"></a>
## type [Scope](<https://github.com/chuxorg/yanzi/blob/master/internal/auth/types.go#L6>)
...
<a name="Scope.Allows"></a>
### func \(Scope\) [Allows](<https://github.com/chuxorg/yanzi/blob/master/internal/auth/types.go#L15>)
...
- [func ResolveAuthHeader\(cfg config.Config, flagAPIKey string\) string](<#ResolveAuthHeader>)
- [type ChainResponse](<#ChainResponse>)
- [type Client](<#Client>)
  - [func New\(baseURL, authHeader string\) \*Client](<#New>)
...
<a name="ResolveAuthHeader"></a>
## func [ResolveAuthHeader](<https://github.com/chuxorg/yanzi/blob/master/internal/client/auth.go#L18>)

```go
func ResolveAuthHeader(cfg config.Config, flagAPIKey string) string
```

ResolveAuthHeader returns the Authorization header value for CLI HTTP mode requests. Returns an empty string if no auth is configured \(no header is sent\).

Resolution order:

1. flagAPIKey \(from \-\-api\-key flag\)
2. YANZI\_API\_KEY environment variable
3. YANZI\_OIDC\_TOKEN environment variable
4. cfg.Auth.APIKey \(config.yaml auth.api\_key\)

<a name="ChainResponse"></a>
## type [ChainResponse](<https://github.com/chuxorg/yanzi/blob/master/internal/client/client.go#L39-L44>)
...
<a name="Client"></a>
## type [Client](<https://github.com/chuxorg/yanzi/blob/master/internal/client/client.go#L19-L23>)
...
<a name="New"></a>
### func [New](<https://github.com/chuxorg/yanzi/blob/master/internal/client/client.go#L67>)
...
The authHeader parameter should be a resolved Authorization header value \(e.g., "Bearer yk\_live\_..."\) or an empty string for unauthenticated requests. Use ResolveAuthHeader to compute this value from flags, env vars, and config.

<a name="Client.ChainIntent"></a>
### func \(\*Client\) [ChainIntent](<https://github.com/chuxorg/yanzi/blob/master/internal/client/client.go#L97>)
...
### func \(\*Client\) [CreateIntent](<https://github.com/chuxorg/yanzi/blob/master/internal/client/client.go#L78>)
...
### func \(\*Client\) [GetIntent](<https://github.com/chuxorg/yanzi/blob/master/internal/client/client.go#L136>)
...
### func \(\*Client\) [ListIntents](<https://github.com/chuxorg/yanzi/blob/master/internal/client/client.go#L107>)
...
### func \(\*Client\) [VerifyIntent](<https://github.com/chuxorg/yanzi/blob/master/internal/client/client.go#L87>)
...
## type [CreateIntentRequest](<https://github.com/chuxorg/yanzi/blob/master/internal/client/client.go#L52-L60>)
...
## type [IntentRecord](<https://github.com/chuxorg/yanzi/blob/master/internal/client/client.go#L26>)
...
## type [ListResponse](<https://github.com/chuxorg/yanzi/blob/master/internal/client/client.go#L47-L49>)
...
## type [VerifyResponse](<https://github.com/chuxorg/yanzi/blob/master/internal/client/client.go#L29-L36>)
...
<a name="RunServe"></a>
## func [RunServe](<https://github.com/chuxorg/yanzi/blob/master/internal/cmd/serve.go#L53>)
...
- [func EffectiveStorageProvider\(cfg Config\) string](<#EffectiveStorageProvider>)
...
- [type PostgresConfig](<#PostgresConfig>)
- [type SQLiteConfig](<#SQLiteConfig>)
...
<a name="LocalDBPathEnvVar"></a>Environment variable names.
...
<a name="ConfigPath"></a>
## func [ConfigPath](<https://github.com/chuxorg/yanzi/blob/master/internal/config/config.go#L295>)
...
## func [DefaultDBPath](<https://github.com/chuxorg/yanzi/blob/master/internal/config/config.go#L313>)
...
## func [EffectiveLocalDBPath](<https://github.com/chuxorg/yanzi/blob/master/internal/config/config.go#L328>)
...
<a name="EffectiveStorageProvider"></a>
## func [EffectiveStorageProvider](<https://github.com/chuxorg/yanzi/blob/master/internal/config/config.go#L343>)

```go
func EffectiveStorageProvider(cfg Config) string
```

EffectiveStorageProvider returns the active provider name. Defaults to "sqlite" if not configured.

<a name="StateDir"></a>
## func [StateDir](<https://github.com/chuxorg/yanzi/blob/master/internal/config/config.go#L304>)
...
<a name="AuthConfig"></a>
## type [AuthConfig](<https://github.com/chuxorg/yanzi/blob/master/internal/config/config.go#L67-L73>)
...
<a name="Config"></a>
## type [Config](<https://github.com/chuxorg/yanzi/blob/master/internal/config/config.go#L25-L32>)
...
<a name="Load"></a>
### func [Load](<https://github.com/chuxorg/yanzi/blob/master/internal/config/config.go#L145>)
...
<a name="Mode"></a>
## type [Mode](<https://github.com/chuxorg/yanzi/blob/master/internal/config/config.go#L17>)
...
<a name="OIDCConfig"></a>
## type [OIDCConfig](<https://github.com/chuxorg/yanzi/blob/master/internal/config/config.go#L46-L53>)
...
<a name="PostgresConfig"></a>
## type [PostgresConfig](<https://github.com/chuxorg/yanzi/blob/master/internal/config/config.go#L100-L105>)
...
<a name="SQLiteConfig"></a>
## type [SQLiteConfig](<https://github.com/chuxorg/yanzi/blob/master/internal/config/config.go#L95-L97>)
...
## type [StorageConfig](<https://github.com/chuxorg/yanzi/blob/master/internal/config/config.go#L88-L92>)
...
<a name="TLSConfig"></a>
## type [TLSConfig](<https://github.com/chuxorg/yanzi/blob/master/internal/config/config.go#L82-L85>)
...
<a name="Instance"></a>
## type [Instance](<https://github.com/chuxorg/yanzi/blob/master/internal/runtime/runtime.go#L54-L59>)
...
### func \(\*Instance\) [Addr](<https://github.com/chuxorg/yanzi/blob/master/internal/runtime/runtime.go#L153>)
...
### func \(\*Instance\) [Shutdown](<https://github.com/chuxorg/yanzi/blob/master/internal/runtime/runtime.go#L169>)
...
### func \(\*Instance\) [StartedAt](<https://github.com/chuxorg/yanzi/blob/master/internal/runtime/runtime.go#L161>)
...
### func \(\*Instance\) [Wait](<https://github.com/chuxorg/yanzi/blob/master/internal/runtime/runtime.go#L183>)
...
<a name="Options"></a>
## type [Options](<https://github.com/chuxorg/yanzi/blob/master/internal/runtime/runtime.go#L25-L41>)
...
<a name="Runtime"></a>
## type [Runtime](<https://github.com/chuxorg/yanzi/blob/master/internal/runtime/runtime.go#L44-L51>)
...
<a name="New"></a>
### func [New](<https://github.com/chuxorg/yanzi/blob/master/internal/runtime/runtime.go#L62>)
...
### func \(\*Runtime\) [Start](<https://github.com/chuxorg/yanzi/blob/master/internal/runtime/runtime.go#L108>)
...
<a name="Artifact"></a>
## type [Artifact](<https://github.com/chuxorg/yanzi/blob/master/internal/storage/types.go#L153-L163>)
...
## type [ArtifactQuery](<https://github.com/chuxorg/yanzi/blob/master/internal/storage/types.go#L46-L51>)
...
<a name="Checkpoint"></a>
## type [Checkpoint](<https://github.com/chuxorg/yanzi/blob/master/internal/storage/types.go#L186-L193>)
...
## type [CheckpointQuery](<https://github.com/chuxorg/yanzi/blob/master/internal/storage/types.go#L69-L71>)
...
## type [ContextArtifactQuery](<https://github.com/chuxorg/yanzi/blob/master/internal/storage/types.go#L54-L61>)
...
## type [CreateArtifactInput](<https://github.com/chuxorg/yanzi/blob/master/internal/storage/types.go#L142-L150>)
...
## type [CreateCheckpointInput](<https://github.com/chuxorg/yanzi/blob/master/internal/storage/types.go#L179-L183>)
...
## type [CreateProjectInput](<https://github.com/chuxorg/yanzi/blob/master/internal/storage/types.go#L166-L169>)
...
## type [ExportCapture](<https://github.com/chuxorg/yanzi/blob/master/internal/storage/types.go#L112-L122>)
...
<a name="ExportItem"></a>
## type [ExportItem](<https://github.com/chuxorg/yanzi/blob/master/internal/storage/types.go#L132-L139>)
...
## type [ExportItemKind](<https://github.com/chuxorg/yanzi/blob/master/internal/storage/types.go#L86>)
...
<a name="ExportMeta"></a>
## type [ExportMeta](<https://github.com/chuxorg/yanzi/blob/master/internal/storage/types.go#L125-L129>)
...
## type [ExportQuery](<https://github.com/chuxorg/yanzi/blob/master/internal/storage/types.go#L74-L78>)
...
<a name="Health"></a>
## type [Health](<https://github.com/chuxorg/yanzi/blob/master/internal/storage/types.go#L38-L43>)
...
## type [HealthStatus](<https://github.com/chuxorg/yanzi/blob/master/internal/storage/types.go#L30>)
...
<a name="IntentRecord"></a>
## type [IntentRecord](<https://github.com/chuxorg/yanzi/blob/master/internal/storage/types.go#L98-L109>)
...
<a name="Project"></a>
## type [Project](<https://github.com/chuxorg/yanzi/blob/master/internal/storage/types.go#L172-L176>)
...
## type [ProjectQuery](<https://github.com/chuxorg/yanzi/blob/master/internal/storage/types.go#L64-L66>)
...
## type [VerificationQuery](<https://github.com/chuxorg/yanzi/blob/master/internal/storage/types.go#L81-L83>)
...
- [func NewCreateKeyHandler\(deps Dependencies\) http.Handler](<#NewCreateKeyHandler>)
...
- [func NewListKeysHandler\(deps Dependencies\) http.Handler](<#NewListKeysHandler>)
...
- [func NewRevokeKeyHandler\(deps Dependencies\) http.Handler](<#NewRevokeKeyHandler>)
...
<a name="NewCreateKeyHandler"></a>
## func [NewCreateKeyHandler](<https://github.com/chuxorg/yanzi/blob/master/internal/api/handlers/keys.go#L17>)
...
## func [NewHealthHandler](<https://github.com/chuxorg/yanzi/blob/master/internal/api/handlers/health.go#L63>)
...
<a name="NewListKeysHandler"></a>
## func [NewListKeysHandler](<https://github.com/chuxorg/yanzi/blob/master/internal/api/handlers/keys.go#L73>)
...
<a name="NewRevokeKeyHandler"></a>
## func [NewRevokeKeyHandler](<https://github.com/chuxorg/yanzi/blob/master/internal/api/handlers/keys.go#L114>)
...
## type [ActiveProjectLoadFunc](<https://github.com/chuxorg/yanzi/blob/master/internal/api/handlers/health.go#L27>)
...
## type [ArtifactReadOpenFunc](<https://github.com/chuxorg/yanzi/blob/master/internal/api/handlers/health.go#L36>)
...
<a name="ArtifactReadStore"></a>
## type [ArtifactReadStore](<https://github.com/chuxorg/yanzi/blob/master/internal/api/handlers/health.go#L30-L33>)
...
## type [ConfigLoadFunc](<https://github.com/chuxorg/yanzi/blob/master/internal/api/handlers/health.go#L21>)
...
## type [Dependencies](<https://github.com/chuxorg/yanzi/blob/master/internal/api/handlers/health.go#L42-L60>)
...
## type [ProviderOpenFunc](<https://github.com/chuxorg/yanzi/blob/master/internal/api/handlers/health.go#L24>)
...
## type [RuntimeStatusFunc](<https://github.com/chuxorg/yanzi/blob/master/internal/api/handlers/health.go#L39>)
...
- [func APIKeyFromContext\(ctx context.Context\) \(auth.APIKey, bool\)](<#APIKeyFromContext>)
- [func AllowMethods\(next http.Handler, methods ...string\) http.Handler](<#AllowMethods>)
- [func Auth\(store auth.APIKeyStore, oidcValidator \*auth.OIDCValidator, cfg config.AuthConfig\) func\(http.Handler\) http.Handler](<#Auth>)
- [func CORS\(next http.Handler\) http.Handler](<#CORS>)


<a name="APIKeyFromContext"></a>
## func [APIKeyFromContext](<https://github.com/chuxorg/yanzi/blob/master/internal/api/middleware/auth.go#L122>)
...
<a name="Auth"></a>
## func [Auth](<https://github.com/chuxorg/yanzi/blob/master/internal/api/middleware/auth.go#L24>)

```go
func Auth(store auth.APIKeyStore, oidcValidator *auth.OIDCValidator, cfg config.AuthConfig) func(http.Handler) http.Handler
```

Auth returns a middleware that enforces authentication when enabled. It tries API key validation first; if the token does not look like an API key it tries OIDC validation \(when oidcValidator is non\-nil\). Both paths use the same scope enforcement logic. Pass nil for oidcValidator to disable OIDC.

<a name="CORS"></a>
## func [CORS](<https://github.com/chuxorg/yanzi/blob/master/internal/api/middleware/cors.go#L11>)

```go
func CORS(next http.Handler) http.Handler
```

CORS adds permissive cross\-origin headers to every response so that browser\-based UI clients served from any local origin can reach yanzi serve without being blocked by the same\-origin policy.
...
- [type APIKeyCreateRequest](<#APIKeyCreateRequest>)
- [type APIKeyCreateResponse](<#APIKeyCreateResponse>)
- [type APIKeyListResponse](<#APIKeyListResponse>)
- [type APIKeySummary](<#APIKeySummary>)
- [type Artifact](<#Artifact>)
...
<a name="APIKeyCreateRequest"></a>
## type [APIKeyCreateRequest](<https://github.com/chuxorg/yanzi/blob/master/internal/api/models/models.go#L190-L194>)
...
<a name="APIKeyCreateResponse"></a>
## type [APIKeyCreateResponse](<https://github.com/chuxorg/yanzi/blob/master/internal/api/models/models.go#L198-L205>)

APIKeyCreateResponse is returned once on key creation. The full plaintext key is shown exactly once and never stored.
...
<a name="APIKeyListResponse"></a>
## type [APIKeyListResponse](<https://github.com/chuxorg/yanzi/blob/master/internal/api/models/models.go#L218-L220>)
...
<a name="APIKeySummary"></a>
## type [APIKeySummary](<https://github.com/chuxorg/yanzi/blob/master/internal/api/models/models.go#L208-L215>)
...
<a name="AuthHealth"></a>
## type [AuthHealth](<https://github.com/chuxorg/yanzi/blob/master/internal/api/models/models.go#L229-L233>)
...
## type [HealthResponse](<https://github.com/chuxorg/yanzi/blob/master/internal/api/models/models.go#L236-L242>)
...
<a name="OIDCHealth"></a>
## type [OIDCHealth](<https://github.com/chuxorg/yanzi/blob/master/internal/api/models/models.go#L223-L226>)
...
## type [StatusResponse](<https://github.com/chuxorg/yanzi/blob/master/internal/api/models/models.go#L184-L187>)
...
<a name="NewHandler"></a>
## func [NewHandler](<https://github.com/chuxorg/yanzi/blob/master/internal/api/routes/routes.go#L28>)

```go
func NewHandler(deps handlers.Dependencies) http.Handler
```

NewHandler constructs the operational API route foundation. Middleware order \(outermost → innermost\): CORS → Auth → handlers.
...
```go
import "github.com/chuxorg/yanzi/internal/auth/testutil"
```

Package testutil provides a minimal in\-process OIDC provider for unit tests. It implements the OIDC discovery document and JWKS endpoints so that go\-oidc can verify tokens without a live identity provider.

## Index

- [type MockOIDCProvider](<#MockOIDCProvider>)
  - [func NewMockOIDCProvider\(t \*testing.T\) \(\*MockOIDCProvider, string\)](<#NewMockOIDCProvider>)
  - [func \(m \*MockOIDCProvider\) SignToken\(claims map\[string\]interface\{\}, expiry time.Duration\) string](<#MockOIDCProvider.SignToken>)
  - [func \(m \*MockOIDCProvider\) SignTokenWithOtherKey\(claims map\[string\]interface\{\}, expiry time.Duration\) string](<#MockOIDCProvider.SignTokenWithOtherKey>)


<a name="MockOIDCProvider"></a>
## type [MockOIDCProvider](<https://github.com/chuxorg/yanzi/blob/master/internal/auth/testutil/mock_oidc.go#L22-L26>)
...
<a name="NewMockOIDCProvider"></a>
### func [NewMockOIDCProvider](<https://github.com/chuxorg/yanzi/blob/master/internal/auth/testutil/mock_oidc.go#L31>)

```go
func NewMockOIDCProvider(t *testing.T) (*MockOIDCProvider, string)
```

NewMockOIDCProvider starts an httptest.Server that serves a valid OIDC discovery document and JWKS. It registers t.Cleanup to stop the server. Returns the provider and its base URL \(the issuer\).

<a name="MockOIDCProvider.SignToken"></a>
### func \(\*MockOIDCProvider\) [SignToken](<https://github.com/chuxorg/yanzi/blob/master/internal/auth/testutil/mock_oidc.go#L88>)

```go
func (m *MockOIDCProvider) SignToken(claims map[string]interface{}, expiry time.Duration) string
```

SignToken creates a signed JWT with the given claims using the mock provider's private key. expiry is added to time.Now\(\) to set the exp claim.

<a name="MockOIDCProvider.SignTokenWithOtherKey"></a>
### func \(\*MockOIDCProvider\) [SignTokenWithOtherKey](<https://github.com/chuxorg/yanzi/blob/master/internal/auth/testutil/mock_oidc.go#L94>)

```go
func (m *MockOIDCProvider) SignTokenWithOtherKey(claims map[string]interface{}, expiry time.Duration) string
```

SignTokenWithOtherKey signs a token with a different RSA key \(simulating a token from a different provider, which should fail verification\).
...
```go
import "github.com/chuxorg/yanzi/internal/storage/postgres"
```

## Index

- [func RunMigrations\(db \*sql.DB\) error](<#RunMigrations>)
- [type Provider](<#Provider>)
  - [func NewProvider\(cfg config.PostgresConfig\) \(\*Provider, error\)](<#NewProvider>)
  ...
  - [func \(p \*Provider\) CreateKey\(ctx context.Context, name string, scope auth.Scope, dev bool\) \(auth.APIKey, string, error\)](<#Provider.CreateKey>)
  ...
  - [func \(p \*Provider\) GetKeyByHash\(ctx context.Context, hash string\) \(auth.APIKey, error\)](<#Provider.GetKeyByHash>)
  ...
  - [func \(p \*Provider\) ListKeys\(ctx context.Context\) \(\[\]auth.APIKey, error\)](<#Provider.ListKeys>)
  ...
  - [func \(p \*Provider\) RevokeKey\(ctx context.Context, id string\) error](<#Provider.RevokeKey>)
  - [func \(p \*Provider\) SQLDB\(\) \*sql.DB](<#Provider.SQLDB>)
  - [func \(p \*Provider\) UpdateLastUsed\(ctx context.Context, id string, at time.Time\) error](<#Provider.UpdateLastUsed>)
  - [func \(p \*Provider\) Verification\(\) bool](<#Provider.Verification>)


<a name="RunMigrations"></a>
## func [RunMigrations](<https://github.com/chuxorg/yanzi/blob/master/internal/storage/postgres/migrate.go#L18>)

```go
func RunMigrations(db *sql.DB) error
```

RunMigrations applies all pending up migrations to the Postgres database using golang\-migrate with the embedded iofs source.

NOTE: m.Close\(\) is intentionally not called because WithInstance passes in an externally\-owned \*sql.DB; calling m.Close\(\) would close that connection.

<a name="Provider"></a>
## type [Provider](<https://github.com/chuxorg/yanzi/blob/master/internal/storage/postgres/provider.go#L22-L27>)
...
### func [NewProvider](<https://github.com/chuxorg/yanzi/blob/master/internal/storage/postgres/provider.go#L31>)

```go
func NewProvider(cfg config.PostgresConfig) (*Provider, error)
```

NewProvider opens a Postgres connection using cfg, configures the pool, verifies connectivity, and runs migrations.

<a name="Provider.Artifacts"></a>
### func \(\*Provider\) [Artifacts](<https://github.com/chuxorg/yanzi/blob/master/internal/storage/postgres/provider.go#L113>)
...
### func \(\*Provider\) [Checkpoints](<https://github.com/chuxorg/yanzi/blob/master/internal/storage/postgres/provider.go#L115>)
...
### func \(\*Provider\) [Close](<https://github.com/chuxorg/yanzi/blob/master/internal/storage/postgres/provider.go#L91>)
...
### func \(\*Provider\) [CreateArtifact](<https://github.com/chuxorg/yanzi/blob/master/internal/storage/postgres/provider.go#L140>)
...
### func \(\*Provider\) [CreateCheckpoint](<https://github.com/chuxorg/yanzi/blob/master/internal/storage/postgres/provider.go#L443>)
...
<a name="Provider.CreateKey"></a>
### func \(\*Provider\) [CreateKey](<https://github.com/chuxorg/yanzi/blob/master/internal/storage/postgres/apikeys.go#L25>)

```go
func (p *Provider) CreateKey(ctx context.Context, name string, scope auth.Scope, dev bool) (auth.APIKey, string, error)
```

CreateKey generates a new API key, stores its hash, and returns the APIKey record plus the full plaintext key. The plaintext key is never stored.

<a name="Provider.CreateProject"></a>
### func \(\*Provider\) [CreateProject](<https://github.com/chuxorg/yanzi/blob/master/internal/storage/postgres/provider.go#L356>)
...
<a name="Provider.GetKeyByHash"></a>
### func \(\*Provider\) [GetKeyByHash](<https://github.com/chuxorg/yanzi/blob/master/internal/storage/postgres/apikeys.go#L58>)
...
### func \(\*Provider\) [GetVerificationIntent](<https://github.com/chuxorg/yanzi/blob/master/internal/storage/postgres/provider.go#L576>)
...
### func \(\*Provider\) [GetVerificationIntentByHash](<https://github.com/chuxorg/yanzi/blob/master/internal/storage/postgres/provider.go#L591>)
...
### func \(\*Provider\) [GetVisibleContextArtifact](<https://github.com/chuxorg/yanzi/blob/master/internal/storage/postgres/provider.go#L285>)
...
### func \(\*Provider\) [Health](<https://github.com/chuxorg/yanzi/blob/master/internal/storage/postgres/provider.go#L99>)
...
### func \(\*Provider\) [ImportExport](<https://github.com/chuxorg/yanzi/blob/master/internal/storage/postgres/provider.go#L117>)
...
### func \(\*Provider\) [ListAllCheckpoints](<https://github.com/chuxorg/yanzi/blob/master/internal/storage/postgres/provider.go#L536>)
...
### func \(\*Provider\) [ListArtifacts](<https://github.com/chuxorg/yanzi/blob/master/internal/storage/postgres/provider.go#L214>)
...
### func \(\*Provider\) [ListCheckpoints](<https://github.com/chuxorg/yanzi/blob/master/internal/storage/postgres/provider.go#L512>)
...
### func \(\*Provider\) [ListExportItems](<https://github.com/chuxorg/yanzi/blob/master/internal/storage/postgres/provider.go#L640>)
...
<a name="Provider.ListKeys"></a>
### func \(\*Provider\) [ListKeys](<https://github.com/chuxorg/yanzi/blob/master/internal/storage/postgres/apikeys.go#L70>)

```go
func (p *Provider) ListKeys(ctx context.Context) ([]auth.APIKey, error)
```

ListKeys returns all non\-revoked keys ordered by creation time, newest first. key\_hash is intentionally excluded.

<a name="Provider.ListProjects"></a>
### func \(\*Provider\) [ListProjects](<https://github.com/chuxorg/yanzi/blob/master/internal/storage/postgres/provider.go#L395>)
...
### func \(\*Provider\) [ListVisibleContextArtifacts](<https://github.com/chuxorg/yanzi/blob/master/internal/storage/postgres/provider.go#L241>)
...
### func \(\*Provider\) [Name](<https://github.com/chuxorg/yanzi/blob/master/internal/storage/postgres/provider.go#L78>)
...
### func \(\*Provider\) [ProjectExists](<https://github.com/chuxorg/yanzi/blob/master/internal/storage/postgres/provider.go#L429>)
...
### func \(\*Provider\) [Projects](<https://github.com/chuxorg/yanzi/blob/master/internal/storage/postgres/provider.go#L114>)
...
<a name="Provider.RevokeKey"></a>
### func \(\*Provider\) [RevokeKey](<https://github.com/chuxorg/yanzi/blob/master/internal/storage/postgres/apikeys.go#L112>)

```go
func (p *Provider) RevokeKey(ctx context.Context, id string) error
```

RevokeKey soft\-deletes a key by setting revoked\_at.

<a name="Provider.SQLDB"></a>
### func \(\*Provider\) [SQLDB](<https://github.com/chuxorg/yanzi/blob/master/internal/storage/postgres/provider.go#L83>)
...
<a name="Provider.UpdateLastUsed"></a>
### func \(\*Provider\) [UpdateLastUsed](<https://github.com/chuxorg/yanzi/blob/master/internal/storage/postgres/apikeys.go#L124>)
...
### func \(\*Provider\) [Verification](<https://github.com/chuxorg/yanzi/blob/master/internal/storage/postgres/provider.go#L116>)
...
## func [EnsureLocalStateDir](<https://github.com/chuxorg/yanzi/blob/master/internal/storage/registry/registry.go#L48>)
...
<a name="Open"></a>
## func [Open](<https://github.com/chuxorg/yanzi/blob/master/internal/storage/registry/registry.go#L20>)

```go
func Open(ctx context.Context, cfg config.Config, opts Options) (storage.Provider, error)
```

Open returns the configured storage provider based on the effective provider name resolved from config and environment variables.

<a name="OpenAtPath"></a>
## func [OpenAtPath](<https://github.com/chuxorg/yanzi/blob/master/internal/storage/registry/registry.go#L43>)
...
## func [ValidateProviderName](<https://github.com/chuxorg/yanzi/blob/master/internal/storage/registry/registry.go#L60>)
...
<a name="Options"></a>
## type [Options](<https://github.com/chuxorg/yanzi/blob/master/internal/storage/registry/registry.go#L16>)
...
- [type Provider](<#Provider>)
  ...
  - [func Open\(ctx context.Context, path string\) \(\*Provider, bool, error\)](<#Open>)
  - [func \(p \*Provider\) Artifacts\(\) bool](<#Provider.Artifacts>)
  - [func \(p \*Provider\) Checkpoints\(\) bool](<#Provider.Checkpoints>)
  - [func \(p \*Provider\) Close\(\) error](<#Provider.Close>)
  - [func \(p \*Provider\) CreateArtifact\(ctx context.Context, input storage.CreateArtifactInput\) \(storage.Artifact, error\)](<#Provider.CreateArtifact>)
...
<a name="RunMigrations"></a>
## func [RunMigrations](<https://github.com/chuxorg/yanzi/blob/master/internal/storage/sqlite/migrate.go#L27>)

```go
func RunMigrations(db *sql.DB) error
```

RunMigrations applies all pending up migrations using golang\-migrate with the embedded iofs source and the modernc SQLite database driver.

For databases previously migrated by the old custom runner, it detects the effective schema version via table/column introspection and bootstraps golang\-migrate to that version before applying any new ones.

NOTE: m.Close\(\) is intentionally not called here. WithInstance passes in an externally\-owned \*sql.DB; calling m.Close\(\) would close that connection.

<a name="Provider"></a>
## type [Provider](<https://github.com/chuxorg/yanzi/blob/master/internal/storage/sqlite/provider.go#L23-L26>)
...
<a name="FromDB"></a>
### func [FromDB](<https://github.com/chuxorg/yanzi/blob/master/internal/storage/sqlite/provider.go#L155>)
...
<a name="Open"></a>
### func [Open](<https://github.com/chuxorg/yanzi/blob/master/internal/storage/sqlite/provider.go#L29>)
...
<a name="Provider.Artifacts"></a>
### func \(\*Provider\) [Artifacts](<https://github.com/chuxorg/yanzi/blob/master/internal/storage/sqlite/provider.go#L97>)
...
<a name="Provider.Checkpoints"></a>
### func \(\*Provider\) [Checkpoints](<https://github.com/chuxorg/yanzi/blob/master/internal/storage/sqlite/provider.go#L99>)
...
<a name="Provider.Close"></a>
### func \(\*Provider\) [Close](<https://github.com/chuxorg/yanzi/blob/master/internal/storage/sqlite/provider.go#L75>)
...
<a name="Provider.CreateKey"></a>
### func \(\*Provider\) [CreateKey](<https://github.com/chuxorg/yanzi/blob/master/internal/storage/sqlite/apikeys.go#L25>)
...
<a name="Provider.GetKeyByHash"></a>
### func \(\*Provider\) [GetKeyByHash](<https://github.com/chuxorg/yanzi/blob/master/internal/storage/sqlite/apikeys.go#L58>)
...
<a name="Provider.Health"></a>
### func \(\*Provider\) [Health](<https://github.com/chuxorg/yanzi/blob/master/internal/storage/sqlite/provider.go#L83>)
...
<a name="Provider.ImportExport"></a>
### func \(\*Provider\) [ImportExport](<https://github.com/chuxorg/yanzi/blob/master/internal/storage/sqlite/provider.go#L101>)
...
<a name="Provider.ListKeys"></a>
### func \(\*Provider\) [ListKeys](<https://github.com/chuxorg/yanzi/blob/master/internal/storage/sqlite/apikeys.go#L70>)
...
<a name="Provider.Name"></a>
### func \(\*Provider\) [Name](<https://github.com/chuxorg/yanzi/blob/master/internal/storage/sqlite/provider.go#L62>)
...
<a name="Provider.Projects"></a>
### func \(\*Provider\) [Projects](<https://github.com/chuxorg/yanzi/blob/master/internal/storage/sqlite/provider.go#L98>)
...
<a name="Provider.RevokeKey"></a>
### func \(\*Provider\) [RevokeKey](<https://github.com/chuxorg/yanzi/blob/master/internal/storage/sqlite/apikeys.go#L105>)
...
<a name="Provider.SQLDB"></a>
### func \(\*Provider\) [SQLDB](<https://github.com/chuxorg/yanzi/blob/master/internal/storage/sqlite/provider.go#L67>)
...
<a name="Provider.UpdateLastUsed"></a>
### func \(\*Provider\) [UpdateLastUsed](<https://github.com/chuxorg/yanzi/blob/master/internal/storage/sqlite/apikeys.go#L117>)
...
<a name="Provider.Verification"></a>
### func \(\*Provider\) [Verification](<https://github.com/chuxorg/yanzi/blob/master/internal/storage/sqlite/provider.go#L100>)
